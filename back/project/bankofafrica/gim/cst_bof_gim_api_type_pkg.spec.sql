create or replace package cst_bof_gim_api_type_pkg as

subtype t_transaction_type is varchar2(2);
subtype t_arn              is varchar2(23);

type t_gim_file_rec is record (
  ...
  , gim_file_id        com_api_type_pkg.t_tag
...
type t_gim_fin_mes_rec is record (
    id                       com_api_type_pkg.t_long_id
  ...
  , card_number              com_api_type_pkg.t_card_number -- for local processing only, not for inserting in cst_bof_gim_fin_msg
  , oper_date                date
  ...
  , transaction_type_tcr3    t_transaction_type
  ...
  , remittance_number        varchar2(6)
  , card_indicator           varchar2(1)
  , voucher_number           varchar2(8)
  , int_fee_amount           com_api_type_pkg.t_money
  , int_fee_currency         com_api_type_pkg.t_curr_code
  , int_fee_sign             varchar2(1)
);
type t_gim_fin_mes_tab is table of t_gim_fin_mes_rec index by binary_integer;
type t_gim_fin_cur is ref cursor return t_gim_fin_mes_rec;
