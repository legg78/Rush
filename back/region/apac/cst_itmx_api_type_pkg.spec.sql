create or replace package cst_itmx_api_type_pkg as

    type            t_itmx_file_rec is record (
    ...
    type            t_itmx_batch_rec is record (
        id                   com_api_type_pkg.t_long_id
    ...
    type            t_itmx_fin_mes_rec is record (
        id                         com_api_type_pkg.t_long_id
      ...
      , file_id                  com_api_type_pkg.t_long_id
      , batch_id                 com_api_type_pkg.t_long_id
      ...
      , card_number              com_api_type_pkg.t_card_number -- for local processing only, not for inserting in CST_ITMX_FIN_MESSAGE
    ...
    type            t_itmx_fin_mes_tab is table of t_itmx_fin_mes_rec index by binary_integer;
    type            t_itmx_fin_cur is ref cursor return t_itmx_fin_mes_rec;
    ...
    type            t_itmx_fin_mes_fraud_rec is record (
        id                         com_api_type_pkg.t_long_id
      , status                   com_api_type_pkg.t_dict_value
      , is_reversal              com_api_type_pkg.t_boolean
      , is_incoming              com_api_type_pkg.t_boolean
      ...
      , sender_country           com_api_type_pkg.t_country_code
      , network_code             com_api_type_pkg.t_inst_id
      , surcharge_amount         com_api_type_pkg.t_money
    ...
    type            t_itmx_fin_mes_fraud_tab is table of t_itmx_fin_mes_fraud_rec index by binary_integer;
    type            t_itmx_fin_fraud_cur is ref cursor return t_itmx_fin_mes_fraud_rec;

    --subtype  t_itmx_fraud_rec is vis_fraud%rowtype;
    ...
    type            t_itmx_multipurpose_rec is record (
        id                         com_api_type_pkg.t_long_id
        , file_id                  com_api_type_pkg.t_long_id
        , record_number            com_api_type_pkg.t_short_id
        , status                   com_api_type_pkg.t_dict_value 
    ...
    type t_itmx_sms1_rec is record(
