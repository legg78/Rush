create or replace package body nps_api_fin_message_pkg as
...
begin
    ...
    select count(*)
      ...
      from nps_fin_message m
         , nps_card c
     where m.status = nps_api_const_pkg.MSG_STATUS_LOADED
       and m.id = c.id
...
begin
    ...
    if l_oper.terminal_type is null then
        ...
        case i_fin_rec.mcc
            when nps_api_const_pkg.MCC_ATM
