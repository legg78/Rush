...
@ViewScoped
@ManagedBean(name = "MbDetachServiceRS")
public class MbDetachServiceRS extends AbstractWizardStep {
    private static final Logger logger =Logger.getLogger(MbDetachServiceRS.class);
    private static final String PAGE = "/pages/common/wizard/callcenter/services/detachServiceRS.jspx";
