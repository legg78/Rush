create or replace package body cst_api_borica_pkg is
...
begin
    trc_log_pkg.debug(
        i_text          => 'cst_api_borica_pkg.define_acquirer_inst default dummy'
    );
...
begin
    trc_log_pkg.debug(
        i_text          => 'cst_api_borica_pkg.is_borica_terminal default dummy'
    );
...
begin
    trc_log_pkg.debug(
        i_text          => 'cst_api_borica_pkg.sttl_postprocess default dummy'
    );
end;
...
begin
    trc_log_pkg.debug(
        i_text          => 'cst_api_borica_pkg.oper_status_postprocess default dummy'
    );
end;
