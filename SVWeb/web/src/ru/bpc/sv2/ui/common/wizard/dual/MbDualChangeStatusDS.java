...
import ru.bpc.sv2.ui.common.wizard.callcenter.MbChangeStatusDS;
...
@ViewScoped
@ManagedBean(name = "MbDualChangeStatusDS")
public class MbDualChangeStatusDS extends MbChangeStatusDS {
    public MbDualChangeStatusDS() {
