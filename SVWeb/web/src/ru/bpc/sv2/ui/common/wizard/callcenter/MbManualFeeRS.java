...
@ViewScoped
@ManagedBean(name = "MbManualFeeRS")
public class MbManualFeeRS extends AbstractWizardStep {
    private static final Logger logger = Logger.getLogger(MbManualFeeRS.class);
    private static final String PAGE_CARD = "/pages/common/wizard/callcenter/manualFeeRS.jspx";
    private static final String PAGE_ACCOUNT = "/pages/common/wizard/callcenter/accManualFeeRS.jspx";
    ...
    public MbManualFeeRS() {
        logger.trace("MbManualFeeRS created...");
    }
