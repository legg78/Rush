create or replace package cst_bnv_napas_api_type_pkg as

type t_bnv_napas_file_rec is record (
...
type t_bnv_napas_fin_mes_rec is record (
    id                        com_api_type_pkg.t_long_id
...
type t_bnv_napas_fin_mes_tab is table of t_bnv_napas_fin_mes_rec index by binary_integer;
type t_bnv_napas_fin_cur is ref cursor return t_bnv_napas_fin_mes_rec;
