...
@ViewScoped
@ManagedBean(name = "MbPreAuthDS")
public class MbPreAuthDS extends AbstractIFX{

	private final static Logger logger = Logger.getLogger(MbPreAuthDS.class);

	private static final String PAGE = "/pages/common/wizard/callcenter/terminal/preAuthDS.jspx";
	...
	protected AthInfoType prepareAuthInfo(){
		...
		athInfo.setAthType("PreAuthorization");
