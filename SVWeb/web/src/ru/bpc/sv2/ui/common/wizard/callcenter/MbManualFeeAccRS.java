...
@ViewScoped
@ManagedBean(name = "MbManualFeeAccRS")
public class MbManualFeeAccRS implements CommonWizardStep {
    private static final Logger logger = Logger.getLogger(MbManualFeeAccRS.class);
    ...
    public MbManualFeeAccRS() {
        logger.trace("MbManualFeeAccRS created...");
    }
