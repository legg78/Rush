...
@ViewScoped
@ManagedBean(name = "MbAccManualFeeAccRetRS")
public class MbAccManualFeeAccRetRS implements CommonWizardStep {
    private static final Logger logger = Logger.getLogger(MbAccManualFeeAccRetRS.class);
    private static final String PAGE_CARD = "/pages/common/wizard/callcenter/manualFeeAccRetRS.jspx";
    private static final String PAGE_ACCOUNT = "/pages/common/wizard/callcenter/accManualFeeAccRetRS.jspx";
    ...
    public MbAccManualFeeAccRetRS() {
        logger.trace("MbAccManualFeeAccRetRS created...");
    }
