...
begin
    for r in (  
        select place_name
          from adr_place a
             , adr_component b
         where a.place_code = i_place_code
           and a.comp_level = i_comp_level
           and a.comp_id = b.id 
           and a.lang = b.lang 
           and b.country_id = decode(i_inst_id,'1001','116','418')
...
begin
    --case for i_tag_name
    /*if i_tag_name = 'DF8020' then
        i_tag_value := 'new address string' ;
    end if;*/
    null;
end;
