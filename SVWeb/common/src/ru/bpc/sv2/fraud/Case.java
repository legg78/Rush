...
public class Case implements Serializable, ModelIdentifiable, Cloneable, IAuditableObject {
	...
	public void setHistDepth(Integer histDepth) {
	...
	public Map<String, Object> getAuditParameters() {
		...
		result.put("histDepth", this.getHistDepth());
