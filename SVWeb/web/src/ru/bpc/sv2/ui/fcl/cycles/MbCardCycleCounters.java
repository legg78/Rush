...
@ManagedBean (name = "MbCardCycleCounters")
public class MbCardCycleCounters extends AbstractTreeBean<TreeCycleCounter> {
	...
	protected void loadTree() {
		...
		try {
			...
			TreeCycleCounter[] trans = _cyclesDao.getCardCycleCounters(userSessionId, params);
