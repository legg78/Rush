create table cst_bof_ghp_fin_msg(
    id                      number(16)
  , status                  varchar2(8)
  , file_id                 number(16)  
...
alter table cst_bof_ghp_fin_msg drop column merchant_province_code
/
alter table cst_bof_ghp_fin_msg add merchant_region varchar2(3)
/
comment on column cst_bof_ghp_fin_msg.merchant_region is 'Merchant region code (Merchant state/province code)'
/
alter table cst_bof_ghp_fin_msg add merchant_number varchar2(15)
/
comment on column cst_bof_ghp_fin_msg.merchant_number is 'Merchant number (Merchant establishment number)'
/
alter table cst_bof_ghp_fin_msg drop column trans_curr_code
/
comment on column cst_bof_ghp_fin_msg.transaction_type is 'Transaction type in TCR 0 (TC x5, x6, x7)'
/
alter table cst_bof_ghp_fin_msg add transaction_type_tcr3 varchar2(2)
/
comment on column cst_bof_ghp_fin_msg.transaction_type_tcr3 is 'Transaction type in TCR 3 (TC x5, x6, x7)'
/
