...
@ViewScoped
@ManagedBean(name = "MbFundsTranferBetweenAccountsRS")
public class MbFundsTranferBetweenAccountsRS extends AbstractWizardStep {
    private static final Logger logger = Logger.getLogger(MbAccountFundsTransferDS.class);
    private static final String PAGE = "/pages/common/wizard/callcenter/account/fundsTransferBetweenAccountsRS.jspx";
