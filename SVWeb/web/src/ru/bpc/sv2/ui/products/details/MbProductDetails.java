...
@RequestScoped
@ManagedBean (name = "MbProductDetails")
public class MbProductDetails implements Serializable {
	...
	public void initializeModalPanel(){
		logger.debug("MbProductDetails initializing...");
		reset();
	...
	public Product getProduct(){
		if(id == null) initializeModalPanel();
		if ((product == null) && (id != null)){
			Filter[] filters = new Filter[] { new Filter("id", id),
					new Filter("lang", language) };
			Product[] products = productsDao.getProducts(userSessionId,
