...
@ViewScoped
@ManagedBean(name = "MbManualFeeAccRetDS")
public class MbManualFeeAccRetDS implements CommonWizardStep {

    private static final Logger classLogger = Logger.getLogger(MbManualFeeAccRetDS.class);
    private static final String PAGE = "/pages/common/wizard/callcenter/manualFeeAccRetDS.jspx";
    ...
    public boolean isShowDialog() {
        classLogger.trace("MbManualFeeAccRetDS::isShowDialog...");
    ...
    public void showOperations() {
        ...
        bean.clearFilter();
        bean.getDisputeFilter().setCustomerId(card.getCustomerId());
        bean.getDisputeFilter().setCustomerNumber(card.getCustomerNumber());
    ...
    public void selectOperation() {
        ...
        if (selected != null) {
            ...
            if (participants.length != 0) {
                ...
                if (participant.getClientIdType().equals(ClientIdentificationTypes.CARD)) {
                    sp = SelectionParams.build("id", participant.getCardId()
                            , "lang", curLang);
                    sp.setRowIndexEnd(1);
    ...
    public void next() {
        classLogger.trace("MbManualFeeAccRetDS::next...");
