create or replace force view aap_ui_merchant_service_vw as
select ps.id
     , ps.parent_id
     , sv.id service_id
     ...
     , decode(
         ...
         where ((st.is_initial = 0 and o.entity_type = 'ENTTMRCH' and o.object_id = m.id)
