create or replace force view net_ui_device_parameter_vw as
  ...
  from (
        ...
        device_param_val as (
            select dv.device_id object_id
                 ...
                 , pr.lov_id
                 , pr.pattern
              from device_version dv
                 , version_parameter pr
             where dv.version_id  = pr.version_id
               and pr.entity_type = 'ENTTCMDV'
        )
        , device_standard as (
            select i.device_id   object_id
