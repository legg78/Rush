...
@ViewScoped
@ManagedBean(name = "MbManualFeeAccRetRS")
public class MbManualFeeAccRetRS implements CommonWizardStep {
    private static final Logger logger = Logger.getLogger(MbManualFeeAccRetRS.class);
    ...
    public MbManualFeeAccRetRS() {
        logger.trace("MbManualFeeAccRetRS created...");
    }
