...
public class ConnectionWrapper implements Connection {
	...
	private boolean is(Class<?> iface) {
		if (iface.getName().equals(OracleConnection.class.getName())) {
			for (Class<?> intClass : target.getClass().getInterfaces()) {
				if (intClass.getName().equals(OracleConnection.class.getName()))
					return true;
			}
		}
		return false;
	...
	public <T> T unwrap(Class<T> iface) throws SQLException {
		return is(iface) ? (T) target : target.unwrap(iface);
	}

	@Override
	public boolean isWrapperFor(Class<?> iface) throws SQLException {
		return is(iface) || target.isWrapperFor(iface);
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof ConnectionWrapper)
			return target.equals(((ConnectionWrapper) obj).target);
		else
