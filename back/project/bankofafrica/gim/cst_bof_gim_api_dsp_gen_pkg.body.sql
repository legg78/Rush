create or replace package body cst_bof_gim_api_dsp_gen_pkg is
...
begin
    ...
    cst_bof_gim_api_dispute_pkg.generate_message_draft(
        o_fin_id               => l_fin_id
      , i_original_fin_id      => l_oper_id
      , i_select_item          => cst_bof_gim_api_const_pkg.DSP_ITEM_FIRST_CHARGEBACK
...
begin
    ...
    cst_bof_gim_api_dispute_pkg.generate_message_draft(
        o_fin_id               => l_fin_id
      , i_original_fin_id      => l_oper_id
      , i_select_item          => cst_bof_gim_api_const_pkg.DSP_ITEM_RVRSL_ON_PRES_CHRGBCK
    );
end;
...
begin
    ...
    cst_bof_gim_api_dispute_pkg.generate_message_draft(
        o_fin_id               => l_fin_id
      , i_original_fin_id      => l_oper_id
      , i_select_item          => cst_bof_gim_api_const_pkg.DSP_ITEM_SECOND_PRESENTMENT
      , i_oper_amount          => l_oper_amount
      , i_oper_currency        => l_oper_currency
      , i_member_msg_text      => l_member_msg_text
      , i_docum_ind            => l_docum_ind
...
begin
    ...
    cst_bof_gim_api_dispute_pkg.generate_message_draft(
        o_fin_id               => l_fin_id
      , i_original_fin_id      => l_oper_id
      , i_select_item          => cst_bof_gim_api_const_pkg.DSP_ITEM_SECOND_PRES_CHRGBCK
      , i_oper_amount          => l_oper_amount
      , i_oper_currency        => l_oper_currency
      , i_member_msg_text      => l_member_msg_text
      , i_docum_ind            => l_docum_ind
...
begin
    ...
    cst_bof_gim_api_dispute_pkg.generate_message_draft(
        o_fin_id               => l_fin_id
      , i_original_fin_id      => l_oper_id
      , i_select_item          => cst_bof_gim_api_const_pkg.DSP_ITEM_RVRSL_ON_SECOND_PRES
      , i_oper_amount          => l_oper_amount
      , i_oper_currency        => l_oper_currency
      , i_member_msg_text      => l_member_msg_text
    );
...
begin
    ...
    l_document_type :=
        dsp_api_shared_data_pkg.get_param_char(
            i_name        => 'GIM_DOCUMENT_TYPE'
          , i_mask_error  => com_api_const_pkg.TRUE
        );
    l_card_iss_ref_num :=
        dsp_api_shared_data_pkg.get_param_char(
            i_name        => 'GIM_CARD_ISSUER_REF_NUM'
          , i_mask_error  => com_api_const_pkg.TRUE
        );
    l_cancellation_ind :=
        dsp_api_shared_data_pkg.get_param_char(
            i_name        => 'GIM_CANCELLATION_INDICATOR'
          , i_mask_error  => com_api_const_pkg.TRUE
        );
    l_response_type :=
        dsp_api_shared_data_pkg.get_param_num(
            i_name        => 'GIM_RESPONSE_TYPE'
          , i_mask_error  => com_api_const_pkg.TRUE
        );

    cst_bof_gim_api_dispute_pkg.generate_retrieval_request(
        o_fin_id               => l_fin_id
      , i_original_fin_id      => l_oper_id
      , i_trans_code           => cst_bof_gim_api_const_pkg.TC_REQUEST_FOR_PHOTOCOPY
...
begin
    ...
    cst_bof_gim_api_dispute_pkg.generate_fee_debit_credit(
        o_fin_id           => l_fin_id
      , i_original_fin_id  => l_oper_id
...
begin
    ...
    l_account_seq_number :=
        dsp_api_shared_data_pkg.get_param_char(
            i_name        => 'GIM_ACCOUNT_SEQ_NUMBER'
          , i_mask_error  => com_api_const_pkg.TRUE
        );
    l_insurance_year :=
        dsp_api_shared_data_pkg.get_param_char(
            i_name        => 'GIM_INSURANCE_YEAR'
          , i_mask_error  => com_api_const_pkg.TRUE
        );
    l_fraud_type :=
        dsp_api_shared_data_pkg.get_param_char(
    ...
    l_debit_credit_indicator :=
        dsp_api_shared_data_pkg.get_param_char(
            i_name        => 'GIM_DEBIT_CREDIT_INDICATOR'
          , i_mask_error  => com_api_const_pkg.TRUE
        );
    l_trans_generation_method :=
        dsp_api_shared_data_pkg.get_param_char(
            i_name        => 'GIM_TRANS_GENERATION_METHOD'
          , i_mask_error  => com_api_const_pkg.TRUE
        );

    cst_bof_gim_api_dispute_pkg.generate_message_fraud(
        o_fin_id                   => l_fin_id
      , i_original_fin_id          => l_oper_id
      , i_oper_amount              => l_oper_amount
      , i_oper_currency            => l_oper_currency
