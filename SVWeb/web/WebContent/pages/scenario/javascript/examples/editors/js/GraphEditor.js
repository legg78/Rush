/*
 * $Id: GraphEditor.js,v 1.43 2009/12/02 15:31:08 gaudenz Exp $
...
function main()
{
    ...
    insertVertexTemplate(library, graph, 'Rectangle', 'images/rectangle.gif', 'rectangle', 100, 40);
    ...
    insertVertexTemplate(library, graph, 'OMG', 'images/icon_arrowright.png', null, 80, 60);
