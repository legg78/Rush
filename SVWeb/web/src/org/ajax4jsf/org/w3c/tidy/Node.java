...
/**
 * IMPORTANT
 * This class is to override default Tidy's Node implementation.
 * This class omits checkNodeIntegrity execution to improve html processing speed
 * checkNodeIntegrity validates parent/child relationship integrity in the DOM tree, but,
 * we suppose Tidy parser is correct and it builds correct tree with proper parent/child relationship
 */
