create or replace package body cst_bof_gim_api_fin_msg_pkg as
...
order by decode(f.logical_file, ''' || cst_bof_gim_api_const_pkg.TC_FSW_HEADER || ''', 2, 1)
       , f.logical_file
       , f.trans_code';
    ...
    if i_start_date is not null or i_end_date is not null then
        ...
        using com_api_const_pkg.FALSE, i_inst_id
...
begin
    ...
    if i_fin_rec.usage_code = '1' then
        l_usage_code := '1';
        case
            when i_fin_rec.trans_code in (cst_bof_gim_api_const_pkg.TC_SALES
                                        , cst_bof_gim_api_const_pkg.TC_VOUCHER
                                        , cst_bof_gim_api_const_pkg.TC_CASH)
            then
                return null;

            when i_fin_rec.trans_code in (cst_bof_gim_api_const_pkg.TC_SALES_CHARGEBACK_REV
                                        , cst_bof_gim_api_const_pkg.TC_VOUCHER_CHARGEBACK_REV
                                        , cst_bof_gim_api_const_pkg.TC_CASH_CHARGEBACK_REV)
            then
                l_tc1 := cst_bof_gim_api_const_pkg.TC_SALES_CHARGEBACK;
                l_tc2 := cst_bof_gim_api_const_pkg.TC_VOUCHER_CHARGEBACK;
                l_tc3 := cst_bof_gim_api_const_pkg.TC_CASH_CHARGEBACK;

            when i_fin_rec.trans_code in (cst_bof_gim_api_const_pkg.TC_FUNDS_DISBURSEMENT)
            then
                l_tc1 := cst_bof_gim_api_const_pkg.TC_FEE_COLLECTION;
                l_tc2 := cst_bof_gim_api_const_pkg.TC_SALES;
                l_tc3 := cst_bof_gim_api_const_pkg.TC_VOUCHER;
                l_tc4 := cst_bof_gim_api_const_pkg.TC_CASH;
                l_tc5 := cst_bof_gim_api_const_pkg.TC_SALES_CHARGEBACK;
                l_tc6 := cst_bof_gim_api_const_pkg.TC_VOUCHER_CHARGEBACK;
                l_tc7 := cst_bof_gim_api_const_pkg.TC_CASH_CHARGEBACK;

            else
                l_tc1 := cst_bof_gim_api_const_pkg.TC_SALES;
                l_tc2 := cst_bof_gim_api_const_pkg.TC_VOUCHER;
                l_tc3 := cst_bof_gim_api_const_pkg.TC_CASH;
        end case;
    else
        l_usage_code := '2';
        case
            when i_fin_rec.trans_code in (cst_bof_gim_api_const_pkg.TC_SALES_CHARGEBACK_REV
                                        , cst_bof_gim_api_const_pkg.TC_VOUCHER_CHARGEBACK_REV
                                        , cst_bof_gim_api_const_pkg.TC_CASH_CHARGEBACK_REV) then
                l_tc1 := cst_bof_gim_api_const_pkg.TC_SALES_CHARGEBACK;
                l_tc2 := cst_bof_gim_api_const_pkg.TC_VOUCHER_CHARGEBACK;
                l_tc3 := cst_bof_gim_api_const_pkg.TC_CASH_CHARGEBACK;
            when i_fin_rec.trans_code in (cst_bof_gim_api_const_pkg.TC_SALES
                                        , cst_bof_gim_api_const_pkg.TC_VOUCHER
                                        , cst_bof_gim_api_const_pkg.TC_CASH) then
                l_usage_code := '1';
                l_tc1 := cst_bof_gim_api_const_pkg.TC_SALES_CHARGEBACK;
                l_tc2 := cst_bof_gim_api_const_pkg.TC_VOUCHER_CHARGEBACK;
                l_tc3 := cst_bof_gim_api_const_pkg.TC_CASH_CHARGEBACK;
...
begin
    select f.id
      ...
      from      cst_bof_gim_fin_msg f
           join cst_bof_gim_fraud   frd    on frd.id = f.id
      left join cst_bof_gim_card    c      on c.id   = f.id
     where f.id = i_id;
exception
...
procedure process_auth(
  ...
  , io_fin_mess_id         in out com_api_type_pkg.t_long_id
    ...
    l_fin_rec                     cst_bof_gim_api_type_pkg.t_gim_fin_mes_rec;
    ...
    begin
        ...
        if l_result is null then
            com_api_error_pkg.raise_error(
                i_error         => 'GIM_ACQ_PROC_BIN_NOT_DEFINED'
...
begin
    ...
    l_fin_rec.logical_file           := cst_bof_gim_api_const_pkg.TC_FL_HEADER;
        ...
        case
            when i_auth_rec.is_reversal = com_api_const_pkg.FALSE then
                case
                    when i_auth_rec.oper_type in (opr_api_const_pkg.OPERATION_TYPE_ATM_CASH
                        ...
                        then cst_bof_gim_api_const_pkg.TC_CASH
                    when i_auth_rec.oper_type in (opr_api_const_pkg.OPERATION_TYPE_PURCHASE
                        ...
                        then cst_bof_gim_api_const_pkg.TC_SALES
                    when i_auth_rec.oper_type in (opr_api_const_pkg.OPERATION_TYPE_REFUND
                        ...
                        then cst_bof_gim_api_const_pkg.TC_VOUCHER
                    else
                        null
                end
            when i_auth_rec.is_reversal = com_api_type_pkg.TRUE then
                case
                    when i_auth_rec.oper_type in (opr_api_const_pkg.OPERATION_TYPE_ATM_CASH
                                                , opr_api_const_pkg.OPERATION_TYPE_POS_CASH)
                        then cst_bof_gim_api_const_pkg.TC_CASH_REVERSAL
                    when i_auth_rec.oper_type in (opr_api_const_pkg.OPERATION_TYPE_PURCHASE
                                                , opr_api_const_pkg.OPERATION_TYPE_UNIQUE
                                                , opr_api_const_pkg.OPERATION_TYPE_P2P_DEBIT
                                                , opr_api_const_pkg.OPERATION_TYPE_SRV_PRV_PAYMENT)
                        then cst_bof_gim_api_const_pkg.TC_SALES_REVERSAL
                    when i_auth_rec.oper_type in (opr_api_const_pkg.OPERATION_TYPE_REFUND
                                                , opr_api_const_pkg.OPERATION_TYPE_PAYMENT
                                                , opr_api_const_pkg.OPERATION_TYPE_P2P_CREDIT
                                                , opr_api_const_pkg.OPERATION_TYPE_CASHIN)
                        then cst_bof_gim_api_const_pkg.TC_VOUCHER_REVERSAL
                    else
                        null
                end
            end;
    if l_fin_rec.trans_code is null then
        trc_log_pkg.error(
            i_text          => 'UNABLE_DETERMINE_GIM_TRANSACTION_CODE'
    ...
    if  i_auth_rec.msg_type = aut_api_const_pkg.MESSAGE_TYPE_COMPLETION
        or l_fin_rec.trans_code in (cst_bof_gim_api_const_pkg.TC_VOUCHER
    ...
    if l_fin_rec.logical_file = cst_bof_gim_api_const_pkg.TC_FL_HEADER then
    ...
    l_fin_rec.payment_product_ind :=
        case l_fin_rec.logical_file
            when cst_bof_gim_api_const_pkg.TC_FV_HEADER then '1'
            when cst_bof_gim_api_const_pkg.TC_FM_HEADER then '2'
            when cst_bof_gim_api_const_pkg.TC_FL_HEADER then '3'
        end;
    ...
    l_fin_rec.trans_code_header :=
        case l_fin_rec.logical_file
            when cst_bof_gim_api_const_pkg.TC_FV_HEADER then cst_bof_gim_api_const_pkg.TC_FV_HEADER
            when cst_bof_gim_api_const_pkg.TC_FM_HEADER then cst_bof_gim_api_const_pkg.TC_FMC_HEADER
            when cst_bof_gim_api_const_pkg.TC_FL_HEADER then cst_bof_gim_api_const_pkg.TC_FL_HEADER
        end;
    ...
    l_fin_rec.sttl_currency  := cst_bof_gim_api_const_pkg.GIM_CURR_CODE;
    l_fin_rec.sttl_amount :=
         round(
             com_api_rate_pkg.convert_amount(
               ...
               , i_dst_currency      => cst_bof_gim_api_const_pkg.GIM_CURR_CODE
               , i_rate_type         => cst_bof_gim_api_const_pkg.GIM_RATE_TYPE
               , i_inst_id           => l_fin_rec.inst_id
    ...
    l_fin_rec.spec_chargeback_ind := get_spec_chargeback_ind(
                                         i_trans_code        => l_fin_rec.trans_code
                                       , i_chargeback_amount => l_fin_rec.oper_amount
                                       , i_original_amount   => l_pre_auth.oper_amount
                                     );

    l_fin_rec.iss_reimb_fee           := 0;
    l_fin_rec.value_date              :=
        case
            when l_fin_rec.trans_code in (cst_bof_gim_api_const_pkg.TC_CASH) then
                l_fin_rec.oper_date

            when l_fin_rec.trans_code in (cst_bof_gim_api_const_pkg.TC_SALES
                                        , cst_bof_gim_api_const_pkg.TC_VOUCHER) then
...
begin
    trc_log_pkg.debug(
        i_text => 'cst_bof_gim_api_fin_msg_pkg.create_operation: START l_oper.id=' || l_oper.id || ' i_fin_rec.trans_code=' || i_fin_rec.trans_code || ' i_standard_id=' || i_standard_id
                    || '  i_status=' || i_status || ' i_incom_sess_file_id=' || i_incom_sess_file_id
    );
    ...
    then
        ...
        l_network_refnum := l_operation.network_refnum;
    ...
    l_oper.oper_type :=
        case
            when i_fin_rec.trans_code in (cst_bof_gim_api_const_pkg.TC_REQUEST_FOR_PHOTOCOPY
                                        , cst_bof_gim_api_const_pkg.TC_FRAUD_ADVICE)
            then
                l_operation.oper_type
            when i_fin_rec.trans_code in (cst_bof_gim_api_const_pkg.TC_FEE_COLLECTION
    ...
    trc_log_pkg.debug(
        i_text =>  'cst_bof_gim_api_fin_msg_pkg.create_operation: l_sttl_type=' || l_sttl_type
    );
    ...
    if l_oper.terminal_type is null then
        ...
        case i_fin_rec.mcc
            when cst_bof_gim_api_const_pkg.MCC_ATM
    ...
    l_oper.network_refnum     := nvl(l_network_refnum, i_fin_rec.arn);
    ...
    if  i_fin_rec.trans_code in (cst_bof_gim_api_const_pkg.TC_SALES
                               , cst_bof_gim_api_const_pkg.TC_VOUCHER
                               , cst_bof_gim_api_const_pkg.TC_CASH)
    ...
    if i_fin_rec.trans_code in (cst_bof_gim_api_const_pkg.TC_FEE_COLLECTION
                               , cst_bof_gim_api_const_pkg.TC_FUNDS_DISBURSEMENT)
    then
        update opr_operation
           set oper_reason = i_fee_rec.reason_code
         where id = l_oper.id;
    end if;

    trc_log_pkg.debug(
        i_text =>  'cst_bof_gim_api_fin_msg_pkg.create_operation: END ' || l_oper.id
    );
...
begin
    ...
    insert into cst_bof_gim_fin_msg(
        id
      , status
      , file_id
      , record_number
      ...
      , i_fin_rec.remittance_number
      , i_fin_rec.card_indicator
      , i_fin_rec.voucher_number
      , i_fin_rec.int_fee_amount
      , i_fin_rec.int_fee_currency
      , i_fin_rec.int_fee_sign
    );

    insert into cst_bof_gim_card(
        id
      , card_number
    ) values (
        l_id
...
begin
    ...
    insert into cst_bof_gim_retrieval(
        id
      , file_id
      , iss_inst_id
      , acq_inst_id
...
is
    l_spec_chargeback_ind      com_api_type_pkg.t_byte_char;
begin
    if i_trans_code in (cst_bof_gim_api_const_pkg.TC_SALES_CHARGEBACK
                      , cst_bof_gim_api_const_pkg.TC_VOUCHER_CHARGEBACK
                      , cst_bof_gim_api_const_pkg.TC_CASH_CHARGEBACK)
       and i_chargeback_amount < i_original_amount
    then
        l_spec_chargeback_ind := 'P';
    else
        l_spec_chargeback_ind := ' ';
    end if;
    
    return l_spec_chargeback_ind;
end get_spec_chargeback_ind;
