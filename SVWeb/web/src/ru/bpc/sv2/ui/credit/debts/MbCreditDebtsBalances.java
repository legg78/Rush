...
@ViewScoped
@ManagedBean(name = "MbCreditDebtsBalances")
public class MbCreditDebtsBalances extends AbstractBean {
        ...
        balancesSource = new DaoDataModel<CreditDebtBalance>(){
            ...
            protected CreditDebtBalance[] loadDaoData(SelectionParams params) {
                ...
                try {
                    ...
                    return creditDao.getDebtBalances(userSessionId, params);
                } catch (Exception e) {
                    setDataSize(0);
            ...
            protected int loadDaoDataSize(SelectionParams params) {
                ...
                try {
                    setFilters();
                    params.setFilters(filters.toArray(new Filter[filters.size()]));
                    return creditDao.getDebtBalancesCount(userSessionId, params);
                } catch (Exception e){
                    setDataSize(0);
                    FacesUtils.addMessageError(e);
                    logger.error("", e);
