...
public class Transliteration {
	...
	public static void main (String[] args) {
		Transliteration t = new Transliteration();
		System.out.println(t.transliterate("Салтыков-Щедрин Задунайский"));
	}
	
	public String transliterate(String rusName) {
		return transliterate(rusName, false);
	}
