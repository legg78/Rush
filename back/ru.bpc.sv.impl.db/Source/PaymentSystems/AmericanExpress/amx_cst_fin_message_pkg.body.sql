create or replace package body amx_cst_fin_message_pkg as
/*********************************************************
...
begin
    trc_log_pkg.debug (
        i_text         => 'amx_cst_fin_message_pkg.process_auth start'
    );


    trc_log_pkg.debug (
        i_text         => 'amx_cst_fin_message_pkg.process_auth end'
    );
end;

end amx_cst_fin_message_pkg;
/
